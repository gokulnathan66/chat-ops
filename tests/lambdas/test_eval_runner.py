...
from src.lambdas.eval_runner import get_stale_sessions, run_evals_for_session, handler


@patch("src.lambdas.eval_runner.settings")
@patch("src.lambdas.eval_runner.boto3")
...
@patch("src.lambdas.eval_runner.run_evals_for_session")
@patch("src.lambdas.eval_runner.get_stale_sessions")
